    ...
    <form class="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
        <div class="card-body">
            ...
            <div class="form-control">
                ...
                <div class="relative w-full">
                    <div class="absolute inset-y-0 right-0 flex items-center px-3">
                        <a class="fill-gray-500 hover:fill-gray-400 cursor-pointer">
                            <svg class="eye hidden" xmlns="http://www.w3.org/2000/svg" height="1em"
            ...
            <div class="form-control">
                ...
                <input class="input input-bordered" type="password"
